...
class OnboardingProfileSerializer(serializers.Serializer):
    ...
    height_cm = serializers.DecimalField(max_digits=5, decimal_places=1, min_value=0.1)
    avg_sitting_hours = serializers.DecimalField(
        max_digits=3, decimal_places=1, min_value=0
    )
...
class OnboardingTargetsSerializer(serializers.Serializer):
    ...
    goal_weight = serializers.DecimalField(max_digits=5, decimal_places=1, min_value=0.1)
    weight = serializers.DecimalField(max_digits=5, decimal_places=1, min_value=0.1)
